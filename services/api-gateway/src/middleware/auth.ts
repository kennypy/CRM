...
// Public paths that don't require authentication. Exported so tests assert
// against the real set instead of a hand-copied duplicate that can drift.
...
export const PUBLIC_PREFIXES = ["/portal/", "/book/"];
