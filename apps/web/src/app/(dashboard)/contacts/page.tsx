 ...
 * Contacts List Page
 *
 * Searchable, paginated table of all Person nodes in the graph.
 * Each row shows: name, email, company affiliation, title, last activity,
 * and influence score (derived from Reality Score inputs on linked deals).
 */
