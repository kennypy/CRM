...
const PUBLIC = ["/login", "/register", "/landing", "/demo/enter", "/start", "/accept-invite", "/portal", "/book", "/embed", "/verify-email"];
...
export function middleware(request: NextRequest) {
  ...
  const isOpenToAll = pathname.startsWith("/portal") || pathname.startsWith("/book") || pathname.startsWith("/embed");
